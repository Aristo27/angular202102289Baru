...
export class ForexComponent implements AfterViewInit {
  ...
  getData(): void{
    console.log("getData()");
    var url = "https://openexchangerates.org/api/latest.json?app_id=0e57ba5446174312bdfe90edb2d16c37";
  ...
  getDataLoop(): void{
    this.http.get("https://openexchangerates.org/api/latest.json?app_id=0e57ba5446174312bdfe90edb2d16c37")
    .subscribe((data: any) => {
      console.log(data);
      this.table_forex.clear();
      var rates = data.rates;
      var No = 0;
      var base = rates.IDR;
      var uang 
